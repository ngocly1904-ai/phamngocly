...
<div class="main-header">
    ...
    <p>Tác giả: Phạm Thị Ngọc Lý - Trường Tiểu học Hùng An - ĐT: 0973151904</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Phạm Thị Ngọc Lý - Trường Tiểu học Hùng An - ĐT: 0973151904</div>", unsafe_allow_html=True)
